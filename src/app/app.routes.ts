...
export const routes: Routes = [
    ...
    { path: 'contacts', data:{title : 'contacts'}, component: ContactsComponent },
    { path: 'addtask', data:{title : 'Add task'}, component: AddTaskPageComponent },
    { path: 'board', data:{title : 'Board'}, component: BoardComponent },
